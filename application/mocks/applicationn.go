...
// MockProductSeviceInterface is a mock of ProductSeviceInterface interface.
type MockProductSeviceInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductSeviceInterfaceMockRecorder
}

// MockProductSeviceInterfaceMockRecorder is the mock recorder for MockProductSeviceInterface.
type MockProductSeviceInterfaceMockRecorder struct {
	mock *MockProductSeviceInterface
}

// NewMockProductSeviceInterface creates a new mock instance.
func NewMockProductSeviceInterface(ctrl *gomock.Controller) *MockProductSeviceInterface {
	mock := &MockProductSeviceInterface{ctrl: ctrl}
	mock.recorder = &MockProductSeviceInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductSeviceInterface) EXPECT() *MockProductSeviceInterfaceMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockProductSeviceInterface) Create(name string, price float64) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductSeviceInterfaceMockRecorder) Create(name, price interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProductSeviceInterface)(nil).Create), name, price)
}

// Disable mocks base method.
func (m *MockProductSeviceInterface) Disable(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Disable indicates an expected call of Disable.
func (mr *MockProductSeviceInterfaceMockRecorder) Disable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Disable", reflect.TypeOf((*MockProductSeviceInterface)(nil).Disable), product)
}

// Enable mocks base method.
func (m *MockProductSeviceInterface) Enable(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// Enable indicates an expected call of Enable.
func (mr *MockProductSeviceInterfaceMockRecorder) Enable(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enable", reflect.TypeOf((*MockProductSeviceInterface)(nil).Enable), product)
}

// Get mocks base method.
func (m *MockProductSeviceInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
...
func (mr *MockProductSeviceInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductSeviceInterface)(nil).Get), id)
}
